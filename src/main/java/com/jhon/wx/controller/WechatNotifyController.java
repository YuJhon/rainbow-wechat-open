...
public class WechatNotifyController {
  ...
  public Object receiveTicket(@RequestBody String requestBody,
    ...
    if (StringUtils.equalsAnyIgnoreCase(appId, "wxd101a85aa106f53e", "wx570bc396a51b8ff8")) {
      try {
        if (StringUtils.equals(inMessage.getMsgType(), "text")) {
          ...
          WxMpKefuMessage keFuMessage = WxMpKefuMessage
                  .TEXT().content(inMessage.getEvent() + "from_callback")
                  .toUser(inMessage.getFromUser())
                  .build();
          wxOpenService.getWxOpenComponentService()
                  .getWxMpServiceByAppid(appId)
  ...
  private WxMpXmlOutMessage route(WxMpXmlMessage message, String appId) {
    try {
      return this.router.route(message, appId);
    } catch (Exception e) {
